...
const services = [
  {
    ...
    description: "Regular cleanings and exams to maintain oral health and prevent cavities and gum disease.",
  ...
  {
    name: "Orthodontics",
    description: "Specialized treatment to straighten teeth and correct bite alignment using braces or aligners.",
  ...
  },
  {
    ...
    description: "A cosmetic procedure to lighten and remove stains for a brighter, whiter smile.",
  ...
  {
    name: "Fillings",
    description: "Restorative treatment to repair cavities and restore the function and appearance of decayed teeth.",
  ...
  {
    name: "Invisalign",
    description: "A series of clear, removable aligners used to discreetly straighten teeth over time.",
  ...
  {
    name: "Veneers",
    description: "Thin, custom-made shells placed over the front of teeth to improve appearance and cover imperfections.",
  ...
  {
    name: "Mouthguards",
    description: "Custom-fitted protective devices worn over teeth to prevent injury during sports or to stop teeth grinding.",
  ...
  {
    name: "Dentures",
    description: "Removable prosthetics designed to replace multiple missing teeth, restoring function and appearance.",
