        ...
        <ul className="hidden lg:flex items-center gap-x-7 xl:gap-x-14">
            {
                links.map((link) => (
                    <li 
                    className={`text font-semibold font-mono tracking-wider ${link.id === "book" ? "bg-warning hover:bg-amber-400 px-5 py-2.5 text-neutral-900 hover:text-neutral-800 transition-colors ease-linear duration-200 cursor-pointer" : "text-info"}`}
                    key={link.id}
                    >
